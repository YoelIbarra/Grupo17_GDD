...
GO
if object_id('[DATASCIENTISTS].MigracionBIDestinos') is not null
	DROP PROCEDURE [DATASCIENTISTS].MigracionBIDestinos;
GO
...
GO
if object_id('DATASCIENTISTS.DIMENSION_DESTINOS') is not null
	DROP TABLE [DATASCIENTISTS].DIMENSION_DESTINOS;
GO
...
CREATE TABLE [DATASCIENTISTS].[DIMENSION_DESTINOS]
(
[ID_TABLA] decimal(18,0) IDENTITY(1,1),
[DES_ID] decimal(18,0),
[HOTEL_ID] decimal(18,0),
[DES_CIUDAD] nvarchar(255),
[DES_DIRECCION] nvarchar(255),
[DES_TOTAL_CAMAS] decimal(18,0),
[DES_CANT_VIAJES] decimal(18,0),
[DES_EDAD_PROM] decimal(18,2),
[DES_GANANCIA_TOTAL] decimal(18,2), 
[DES_MAYOR_ORIGEN] nvarchar(255),
[DES_DIAS_PROM] decimal(18,2),
CONSTRAINT PK_DIMENSION_DESTINOS PRIMARY KEY(ID_TABLA)
);
...
--DIMENSION DESTINOS
CREATE PROCEDURE [DATASCIENTISTS].MigracionBIDestinos
AS
BEGIN
	INSERT INTO DATASCIENTISTS.DIMENSION_DESTINOS
	(DES_ID,HOTEL_ID, DES_CIUDAD, DES_DIRECCION, DES_TOTAL_CAMAS, DES_CANT_VIAJES, DES_EDAD_PROM, DES_GANANCIA_TOTAL,
	 DES_MAYOR_ORIGEN, DES_DIAS_PROM)
	(	(SELECT
		--DES ID (CA)
		NULL,
		--HOTEL ID
		...
		GROUP BY HO.HOTEL_ID, HO.HOTEL_CALLE)
		UNION
		(SELECT
		--DES ID (DESTINO)
		...
		CAST((AVG(CAST((YEAR(GETDATE()) -YEAR(CL.CLIENTE_FECHA_NAC)) AS decimal(18,2))))as decimal(18,2)),
		--GANANCIA TOTAL
		 CAST((SUM(PA.PASAJE_PRECIO)) as decimal (18,2)),
		--DES MAYOR ORIGEN
		(	SELECT TOP 1 CI2.CIUDAD_NOMBRE
			...
			HAVING VU.VUELO_RUTA_AEREA_DEST = vu2.VUELO_RUTA_AEREA_DEST
...
EXEC DATASCIENTISTS.MigracionBIDestinos;
GO
